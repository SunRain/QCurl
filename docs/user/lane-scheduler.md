...
> 本页面面向 QCurl 使用者，说明 2.0.0 lane scheduler public contract。代码事实以 `src/QCNetworkRequest.h`、`src/QCNetworkLaneKey.h`、`src/QCNetworkSchedulerPolicy.h`、`src/QCNetworkAccessManager.h` 和对应测试为准。
