...
**功能**: 演示 `QCNetworkDownloadToDeviceJob`、`QCNetworkMultipartBody` 与 `QCNetworkResumableDownloadJob` 的组合用法
...
- **WebSocketDemo** - WebSocket 基础示例（需要 libcurl 7.86.0+）
...
- **Qt6** (QtCore)
- **libcurl** 7.85.0+（WebSocket 需 7.86.0+；HTTP/3 推荐 8.16.0+）
- **C++17**
- **CMake** 3.16+
