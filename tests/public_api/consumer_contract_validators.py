...
def validate_scheduler_core_contract_fixture(source_dir: Path) -> None:
    ...
    _require_snippets(
        ...
        [
            ...
            "manager.setSchedulerPolicy(",
            "manager.schedulerPolicy()",
            "manager.schedulerStatistics()",
            "QCurl::QCNetworkLaneCancelResult",
            "manager.cancelLaneRequests(",
            "cancelledPending.status()",
...
def validate_connection_pool_core_contract_fixture(source_dir: Path) -> None:
    ...
    _require_snippets(
        ...
        [
            ...
            "poolConfig.multiMaxHostConnections()",
            "poolConfig.multiMaxConcurrentStreams()",
            "poolConfig.multiMaxConnects()",
