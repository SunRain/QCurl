...
def validate_cookie_async_result_core_contract_fixture(source_dir: Path) -> None:
    ...
    _require_snippets(
        ...
        [
            ...
            "QCurl::QCCookieOperationResult defaultFailure",
            "QCurl::QCCookieOperationResult::failure(",
            "QCurl::QCCookieAsyncError::BusinessError",
            "cookieImportSuccess.isSuccess()",
            "cookieImportFailure.errorCode()",
            "cookieImportFailure.policyCode()",
            ...
            "QCurl::QCCookieAsyncError::ManagerDestroyed",
            "cookieExportSuccess.cookies()",
            "cookieExportFailure.errorCode()",
